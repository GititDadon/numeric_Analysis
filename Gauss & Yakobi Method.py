...
def Gauss_Seidel_Method(A, n, B):
    ...
    while (abs(subMat(Xr1, Xr)) > 0.001):
        ...
        for x,j in enumerate(z):
            ...
            if x%3==2:
                print("\t")
    print(colored("~~~~Gauss Szeidel Method End Result:~~~~", color='red'))
    print('a:', -z[-3], 'b:', z[-1], 'c:', z[-2])
    return
...
def Yakobi_Method(mat, n, B):
    ...
    while abs(subMat(Xr1, Xr)) > 0.001:
        ...
        for x, j in enumerate(z):
            ...
            if x % 3 == 2:
                print("\t")
    print(colored("~~~~Yaakobi Method End Result:~~~~",color='red'))
    print('a:',-z[-3],'b:',z[-1],'c:',z[-2])
    return
...
def main():
    ...
    # Daignolly Dominant, Therfore No Equations Arrangment Is Required.
